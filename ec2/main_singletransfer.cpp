...
void _help(char *argv[])
{
  ...
  printf("Sample0.1 [非DTU，发送方]:\n"\
		"./ec_singletransfer ../log/ECSingleTransfer_RSdata01.log \""\
  ...
  printf("Sample0.2 [非DTU，接收方]:\n"\
		"./ec_singletransfer ../log/ECSingleTransfer_RSdata02.log \""\
  ...
  printf("Sample1.1 [DTU，发送方]:\n"\
		"./ec_singletransfer ../log/ECSingleTransfer_RSdata11.log \""\
			"<inifilepath>../config_dtu.ini</inifilepath>"\
			"<dtu>1</dtu>"\
			"<role>1</role>"\
			...
			"<remotetid>102</remotetid>"\
			"<sendfilename>file.txt</sendfilename>"\
			"<sendfilepath>../file.txt</sendfilepath>"\
      "\"\n\n");
  printf("Sample1.2 [DTU，接收方]:\n"\
		"./ec_singletransfer ../log/ECSingleTransfer_RSdata12.log \""\
			"<inifilepath>../config_dtu.ini</inifilepath>"\
			"<dtu>1</dtu>"\
			"<role>2</role>"\
